...
|--------|---------|-----------|-------------|---------------|
| P/E    | 15.75   | Not found in available filings | ~15.37 (midpoint of SU 15.75 and CNQ 14.98) | Not found in available filings |
| EV/EBITDA | 7.01 | Not found in available filings | 7.20 (median of SU 7.01, CNQ 7.38, IMO ~9.93, CVE 5.65) | Not found in available filings |
| P/FCF  | 13.34   | Not found in available filings | Not found in available filings | Not found in available filings |
| P/S    | 1.91    | Not found in available filings | Not found in available filings | Not found in available filings |

Suncor trades at 7.01x EV/EBITDA, which sits between CNQ (7.38x) and CVE (5.65x), and well below IMO (8.21-11.64x). The 15.75x trailing P/E is slightly above CNQ's 14.98x but reasonable for the most vertically integrated Canadian oil sands producer. Forward P/E of 19.34x is elevated relative to CNQ's 15.49x, reflecting analyst consensus that 2026 EPS ($3.85) will decline from TTM EPS ($3.54 reported, though some sources show higher), largely on weaker commodity price assumptions.

[suncor-valuation-data.md, Valuation Multiples]: "P/E (Trailing) 15.75", "EV/EBITDA 7.01", "P/FCF 13.34", "P/S 1.91"
[suncor-peers.md, Valuation Comparison]: "CNQ 7.38, IMO 8.21-11.64, CVE 5.65"
...
**Current Price:** $56.84
**Implied Revenue Growth Rate:** ~0-2% annually over 5 years (flat to slight growth)
**Implied Margin Assumptions:** EBITDA margins sustaining at ~30% (current TTM EBITDA margin: $10.88B / $35.67B = 30.5%), with FCF conversion around 14-15% of revenue ($5.10B / $35.67B = 14.3%)
...
**Assumptions for reverse DCF:** Discount rate of 10% (typical for integrated energy), terminal growth of 0%, 10-year horizon. Revenue of $35.67B (TTM) growing at ~1.5% annually with 30% EBITDA margins and $5.8-6.0B annual capex yields a fair value of approximately $55-58 per share, aligning with the current price. This implies the market is pricing in essentially no growth.
...
**Assumptions:**
- Revenue growth: WTI sustains >$70/bbl, driving upstream revenue growth of 8-12% annually. Record production continues, reaching 900,000+ bbls/d by 2027.
- Margin trajectory: EBITDA margins expand to 33-35% as operational efficiencies compound (upgrader and refinery utilization sustained above 100%), per-barrel OS&G costs continue declining, and refining crack spreads remain supportive. Normalized FFFlow at US$75 WTI reaches $9.5-10B by 2027 (vs $8.5B in 2025).
- Multiple: EV/EBITDA re-rates to 8.0x (toward IMO's premium range, justified by sustained operational excellence and best-in-class integration). Share count declines 4-5% annually via $3.3B+ buyback program.
...
**Assumptions:**
- Revenue growth: WTI averages $55-65/bbl range through 2027, consistent with EIA and Goldman forecasts. Revenue flat to slightly declining on commodity headwinds, partially offset by 2-3% annual production growth and record refining throughput.
- Margin trajectory: EBITDA margins compress modestly to 28-30% as lower oil prices offset operational improvements. Normalized FFFlow at US$75 WTI grows 5-8% annually to ~$9.0B by 2027. Actual FFFlow in the $6.0-7.0B range at realized prices.
...
[Financial Deep Dive.md, Margin Progression]: EBITDA margins have ranged from ~27-31% depending on commodity price environment
[suncor-valuation-data.md, Valuation Multiples]: "EV/EBITDA 7.01"

### Bear Case (Structural Deterioration)
**Assumptions:**
- Revenue growth: WTI falls below $50/bbl on sustained supply glut (world oil output +2.4 mb/d, 477 mb inventory builds) and demand weakness. Revenue declines 15-20% from TTM. Carbon regulation tightens, increasing per-barrel costs by $3-5/bbl.
- Margin trajectory: EBITDA margins compress to 22-25% as upstream losses dominate even with refining hedge. Normalized FFFlow declines to $6.0-6.5B at US$75 WTI as cost inflation from carbon regulation erodes structural gains. Actual FFFlow drops to $3.0-4.0B at realized WTI <$50.
...
1. **Oil price is the dominant variable.** Every $10/bbl move in WTI shifts annual EBITDA by roughly $2.5-3.0B and fair value by $15-20/share. The entire valuation range ($34-$78) is driven primarily by the commodity price assumption, not by disagreement about Suncor's operational quality. (Inferred from the relationship between normalized FFFlow at US$75 and actual FFFlow at realized prices.)

2. **Sustainability of operational improvements.** The base case assumes Suncor holds utilization rates near current records (103% refinery, 99% upgrader annual). If utilization mean-reverts to 95-97% (pre-Kruger levels), per-unit economics deteriorate meaningfully. The moat analysis rates these improvements as structural, but any analysis must acknowledge that 103% refinery utilization and 106% quarterly upgrader utilization may be near physical ceilings.

3. **Share buyback execution.** At $275M/month (~$3.3B annually), buybacks contribute ~4-5% annual per-share value accretion. This assumes management maintains this pace regardless of commodity environment; in a bear case, buybacks would likely slow, reducing per-share value creation. [suncor-q4-2025-earnings.md, 2026 Guidance]: "Monthly share repurchases increasing 10% to $275M"

4. **EV/EBITDA multiple stability.** The base case assumes 7.0x is sustainable. If ESG-driven capital reallocation accelerates or terminal demand concerns deepen, integrated oil companies could see structural multiple compression toward 4-5x, which would reduce fair value materially even with stable cash flows.

### Data Gaps

- **5-year average multiples:** Not available in filings. Required to assess whether current multiples are historically high, low, or average for Suncor. Bloomberg/FactSet terminal data recommended.
- **Sector median multiples:** Not available. Required for proper relative valuation context beyond the four Canadian peers.
- **Segmented margins by business unit:** Full upstream vs downstream margin split not available in quarterly earnings summaries. Required to properly model the natural hedge between upstream and refining under different commodity scenarios.
- **Break-even WTI price:** Not explicitly stated in any filing. Required to assess downside protection in a sustained low-price environment. [Financial Deep Dive.md, Break-Even Analysis]: "Implied break-even WTI: Not explicitly stated in filings"
- **Environmental/reclamation liabilities:** Not quantified. Oil sands operators carry significant future reclamation obligations that could be a material unquantified liability. [Financial Deep Dive.md, Red Flags]: "Environmental/reclamation liabilities: Not quantified in available filings"
- **Pension/OPEB obligations:** Not discussed. Could represent hidden liabilities affecting equity value.
- **Off-balance-sheet items:** Not detailed. Full 10-K review recommended.
- **Forward consensus estimates beyond 2026:** Only 2026E EPS of $3.85 is available. Multi-year forward estimates would improve DCF precision.
