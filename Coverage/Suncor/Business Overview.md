...
Suncor's operations are heavily concentrated in Canada. The Oil Sands and Refining & Marketing segments are entirely Canadian-based. The E&P segment provides some international exposure.

| Region | Operations | Key Assets |
|--------|-----------|------------|
| Canada (Alberta) | Oil Sands mining & in-situ, upgrading | Base Plant, Firebag, Syncrude, Fort Hills |
...
|--------|---------|---------|---------|---------|---------|
| Production (bbls/d) | 790,900 | N/A | N/A | 812,200 | 845,400 (inferred) |
| Adj. Operating Earnings ($M) | $1,620 | $1,365 | $926 | N/A | N/A |

[suncor-q1-2025-earnings, Segment Performance]: "Oil Sands: Adjusted operating earnings increased to $1,620M (Q1 2025) from $1,365M (Q1 2024), primarily due to narrower heavy crude oil and SYN-WTI differentials, favorable FX rates"
...
|--------|---------|---------|---------|---------|
| Production (bbls/d) | 62,300 | 50,300 | 57,800 | 63,600 |
| Adj. Operating Earnings ($M) | $158 | $274 | N/A | N/A |

[suncor-q1-2025-earnings, Segment Performance]: "E&P: Adjusted operating earnings decreased to $158M (Q1 2025) from $274M (Q1 2024), due to lower sales volumes, increased exploration expense, and lower realized crude prices"

### Refining & Marketing (Downstream)
Four refineries across Canada plus the Petro-Canada retail network. This segment provides critical earnings diversification by capturing refining margins.

| Metric | FY 2024 | FY 2025 |
|--------|---------|---------|
| Refinery Throughput (bbls/d) | 465,000 (record) | 480,000 (record) |
| Refinery Utilization | 100% (record) | 103% (record) |
| Refined Product Sales (bbls/d) | 599,000 (record) | 623,000 (record) |

[suncor-2024-annual, Production & Operations]: "Annual Refinery Utilization: 100% (record, +5% vs prior best)"
[suncor-q4-2025-earnings, Full Year 2025 Results]: "Refinery Utilization: 103% (record)" and "Refinery Throughput: 480,000 bbls/d (record)"

### Consolidated Operating Summary

| Metric | FY 2023 | FY 2024 | FY 2025 | Trend |
|--------|---------|---------|---------|-------|
| Total Upstream Production (bbls/d) | 745,700 | 827,600 | 860,000 | Record growth each year |
| Adj. Funds from Operations ($M) | $13,325 | $13,846 | $12,783 | Declining on commodity prices |
| Free Funds Flow ($M) | $7,497 | $7,363 | $6,927 | Declining on commodity prices |
| Refinery Utilization | 90% | 100% | 103% | Step-change improvement |
| Net Debt ($M) | $13,678 | $6,861 | $6,337 | Rapid deleveraging |
| Total Shareholder Returns ($M) | $5,000 | $5,700 | $5,800 | Steadily increasing |
| Normalized FFF (US$75 WTI, $M) | N/A | $7,373 | $8,476 | +15% YoY |
